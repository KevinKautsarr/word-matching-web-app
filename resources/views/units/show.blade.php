...
@section('content')
<div class="min-h-screen font-dm" style="background:#0d0f1a;">

    {{-- ========= STYLES ========= --}}
    <style>
        .lesson-card { background: var(--card); border: 1px solid var(--border); border-radius: 1.25rem; transition: all 0.2s cubic-bezier(0.175, 0.885, 0.32, 1.275); position: relative; overflow: hidden; backdrop-filter: blur(16px); }
